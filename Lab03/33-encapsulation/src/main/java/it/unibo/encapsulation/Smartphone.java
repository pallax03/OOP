...
public class Smartphone {
    ...
    public void printStringRep() {
        System.out.println("n CPU(s): " + getCpuCount());
        System.out.println("RAM amount: " + getRam());
        System.out.println("SD size: " + getSdSize());
        System.out.println("brand: " + getBrand());
        System.out.println("model: " + getModel());
        System.out.println("hasGPS: " + getHasGPS());
        System.out.println("has3G: " + getHas3G());
        System.out.println("hasNFC: " + getHasNFC() + "\n");
    }
